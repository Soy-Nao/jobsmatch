...
const Benefits = () => {
  return (
    <div>
      <div>
        <h1 className="text-5xl font-bold text-primary flex justify-center">
          Beneficios
        </h1>
      </div>
      <div className=" max-w-5xl h-[60vh] grid grid-cols-1 md:grid-cols-9 ">
        <div className="md:col-span-3  flex flex-col items-center p-6 p">
          <img
            className=""
        ...
        <div className="md:col-span-3 flex flex-col items-center p-6 ">
